...
const routes: Routes = [
    ...
    // Auth routes for guests 🚻
    {
        ...
        children: [
            ...
            {path: 'activate-account/:email/:token', loadChildren: () => import('app/modules/auth/confirmation-required/confirmation-required.module').then(m => m.AuthConfirmationRequiredModule)},
